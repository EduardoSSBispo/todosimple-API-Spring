...
public class User {
    ...
    } // Interface para validação de criação de usuário

    public interface UpdateUser {
    } // Interface para validação de atualização de usuário
    ...
    // (groups = CreateUser.class) é uma forma de dizer que a validação só deve ser
    // feita quando o objeto for criado
    // {CreateUser.class, UpdateUser.class} é uma forma de dizer que a validação
    // deve ser feita tanto na criação quanto na atualização
    ...
    // mappedBy serve para dizer que o mapeamento foi feito na outra classe, uso o
    // nome da variável que está na outra classe
